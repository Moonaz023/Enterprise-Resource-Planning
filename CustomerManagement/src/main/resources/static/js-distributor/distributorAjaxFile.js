...
$(document).ready(function() {
	...
	$("#insert").click(function() {
		...
		$.ajax({
			type: "POST",
			url: "/distributor/admin/saveDistributor",
			data: form.serialize(),
			headers: {
...
function getDistributors() {
	$.ajax({
		type: "GET",
		url: "/distributor/admin/getAllDistributors", // Replace with your actual endpoint
		headers: {
			'Authorization': `Bearer ${localStorage.getItem('jwtToken')}`
		}, 
...
function deleteRecord(id) {
	$.ajax({
		type: "DELETE",
		url: "/distributor/admin/deleteDistributor?id=" + id,
		headers: {
			'Authorization': `Bearer ${localStorage.getItem('jwtToken')}`
		}, 
		success: function() {
...
function editRecord(id) {
	...
	$("#update").click(function(event) {
		...
		$.ajax({
			type: "POST",
			url: "/distributor/admin/updateDistributor",
