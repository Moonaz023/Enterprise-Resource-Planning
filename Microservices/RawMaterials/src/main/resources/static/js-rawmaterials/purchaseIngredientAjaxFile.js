...
function getVendors() {
	$.ajax({
		type: "GET",
		url: "/rawmaterials/admin/getAllVendors",
		headers: {
...
$("#insertPurchase").click(function() {
	...
	$.ajax({
		type: "POST",
		url: "/rawmaterials/admin/savePurchasedIngredient",
		data: form.serialize(),
		headers: {
			'Authorization': `Bearer ${localStorage.getItem('jwtToken')}`
		},
...
function getAllPurchasedIngredients() {
	$.ajax({
		type: "GET",
		url: "/rawmaterials/admin/getAllPurchasedIngredients",
		headers: {
			'Authorization': `Bearer ${localStorage.getItem('jwtToken')}`
		},
...
function deleteIngredientPurchaseRecord(id) {
	$.ajax({
		type: "DELETE",
		url: "/rawmaterials/admin/deleteIngredientPurchaseRecord?id=" + id,
		headers: {
			'Authorization': `Bearer ${localStorage.getItem('jwtToken')}`
		},
		success: function(result) {
...
function editIngredientPurchaseRecord(id) {
	...
	$("#updateIngredientPurchase").click(function(event) {
		...
		$.ajax({
			type: "POST",
			url: "/rawmaterials/admin/updateIngredientPurchase",
